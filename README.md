# Boas vindas ao meu repositório do Projeto Playground Functions (Segundo projeto da Trybe-TurmaXp)!

Este projeto foi voltado a lógica de programação. Aqui no README.md estão todos os desafios e no arquivo .js estão os scripts.
